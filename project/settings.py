...
MIDDLEWARE = [
    ...
    "project.middleware.metric_middleware.metric_middleware",
    "project.middleware.token_decode_middleware.HandleJWTokenMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "project.custom.pagination.CustomPageSizePagination",
}
